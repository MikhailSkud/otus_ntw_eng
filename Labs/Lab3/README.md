...
### Часть 2: Настройка и проверка работоспособности двух DHCPv4 серверов (пулов)  на маршрутизаторе R1.
...
#### Шаг 4: Попытка получить ip-адрес на PC-A
...
Настроим маршрутизатор R2 в качестве ретранслятора DHCP запросов к R1 из сети на интерфейсе Gi0/1

#### Шаг 1: Настройка маршрутизатора R2 в качестве агента DHCP ретрансляции для сети на интерфейсе Gi0/1

![alt text](image-9.png)

#### Шаг 2: Попытка получить ip-адрес на PC-B
